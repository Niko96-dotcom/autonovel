...
# 1. Setup
cd ~/autonovel
cp .env.example .env   # Configure Anthropic or an OpenAI-compatible model
uv sync
...
3. Revise through automated cycles + whole-book review (Phase 3)
...
uv run python review.py                         # configured-model dual-persona review
